...
.method private a(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iget-object v5, p0, Lcom/baidu/android/pushservice/c/b;->c:Landroid/content/Context;

    invoke-static {v5, v2}, Lcom/baidu/android/pushservice/util/v;->k(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v5, v2}, Lcom/baidu/android/pushservice/util/t;->h(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    iget-object v9, p0, Lcom/baidu/android/pushservice/c/b;->c:Landroid/content/Context;

    invoke-static {v9, v2}, Lcom/baidu/android/pushservice/util/t;->i(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/baidu/android/pushservice/util/v;->E(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v10}, Lcom/baidu/android/pushservice/util/v;->s(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Context;
    ...
    invoke-static {v9, v2, p1}, Lcom/baidu/android/pushservice/util/w;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, ".self_push_sync"
    ...
    const-string v5, "bindinfo"

    invoke-static {v9, v1, v5}, Lcom/baidu/android/pushservice/util/w;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v12, v1, Lcom/baidu/android/pushservice/c/h;->c:Ljava/lang/String;
    ...
    iget-object v11, v2, Lcom/baidu/android/pushservice/c/h;->a:Ljava/lang/String;
    ...
    const-string v9, "syncRegisterDataImpl Exception: "
    ...
    invoke-static {v5}, Lcom/baidu/android/pushservice/c/b;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/baidu/android/pushservice/c/b;->g(Ljava/lang/String;)Lcom/baidu/android/pushservice/c/h;
    ...
    iget-object v1, v1, Lcom/baidu/android/pushservice/c/h;->c:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/baidu/android/pushservice/c/b;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/baidu/android/pushservice/c/b;->c:Landroid/content/Context;

    invoke-static {v2, v1}, Lcom/baidu/android/pushservice/util/s;->f(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v2, v7, p1, v1}, Lcom/baidu/android/pushservice/util/w;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public final a(IZ)Lcom/baidu/android/pushservice/c/h;
    .locals 4
...
.method public final a(Ljava/lang/String;Lcom/baidu/android/pushservice/e/g;)V
    .locals 1
...
.method public final d(Ljava/lang/String;)Lcom/baidu/android/pushservice/c/h;
    ...
    invoke-static {v1, v3}, Lcom/baidu/android/pushservice/util/t;->h(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/baidu/android/pushservice/util/v;->E(Landroid/content/Context;)Z
    ...
    invoke-static {v3, v4}, Lcom/baidu/android/pushservice/util/v;->s(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Context;
    ...
    invoke-static {v3, v0, v1}, Lcom/baidu/android/pushservice/util/w;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
