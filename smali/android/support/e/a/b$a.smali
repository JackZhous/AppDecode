...
.field b:Landroid/support/e/a/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/e/a/b$a;Landroid/graphics/drawable/Drawable$Callback;Landroid/content/res/Resources;)V
    ...
    .line 476
    iget-object v0, p2, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;
    ...
    invoke-virtual {v0}, Landroid/support/e/a/h;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    check-cast v0, Landroid/support/e/a/h;

    iput-object v0, p0, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;

    .line 483
    :goto_0
    iget-object v0, p0, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;

    invoke-virtual {v0}, Landroid/support/e/a/h;->mutate()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p3}, Landroid/support/e/a/h;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 485
    iget-object v0, p0, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;

    iget-object v2, p2, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;

    invoke-virtual {v2}, Landroid/support/e/a/h;->getBounds()Landroid/graphics/Rect;

    move-result-object v2

    invoke-virtual {v0, v2}, Landroid/support/e/a/h;->setBounds(Landroid/graphics/Rect;)V

    .line 486
    iget-object v0, p0, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;

    invoke-virtual {v0, v1}, Landroid/support/e/a/h;->a(Z)V
    ...
    .line 496
    iget-object v4, p0, Landroid/support/e/a/b$a;->b:Landroid/support/e/a/h;

    invoke-virtual {v4, v0}, Landroid/support/e/a/h;->a(Ljava/lang/String;)Ljava/lang/Object;
