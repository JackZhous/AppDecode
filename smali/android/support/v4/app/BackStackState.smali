...
.method public constructor <init>(Landroid/support/v4/app/w;)V
    ...
    .line 48
    iget-object v1, p1, Landroid/support/v4/app/w;->l:Ljava/util/ArrayList;
    ...
    .line 51
    iget-boolean v1, p1, Landroid/support/v4/app/w;->s:Z
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/app/w;->l:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v4/app/w$a;->a:I
    ...
    iget v6, v0, Landroid/support/v4/app/w$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/app/w$a;->e:I
    ...
    .line 65
    :cond_2
    iget v0, p1, Landroid/support/v4/app/w;->q:I
    ...
    .line 67
    iget-object v0, p1, Landroid/support/v4/app/w;->u:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    .line 68
    iget v0, p1, Landroid/support/v4/app/w;->w:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    .line 69
    iget v0, p1, Landroid/support/v4/app/w;->x:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    .line 70
    iget-object v0, p1, Landroid/support/v4/app/w;->y:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    .line 71
    iget v0, p1, Landroid/support/v4/app/w;->z:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    .line 72
    iget-object v0, p1, Landroid/support/v4/app/w;->A:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    .line 73
    iget-object v0, p1, Landroid/support/v4/app/w;->B:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    .line 74
    iget-object v0, p1, Landroid/support/v4/app/w;->C:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    .line 75
    iget-boolean v0, p1, Landroid/support/v4/app/w;->D:Z
...
# virtual methods
.method public a(Landroid/support/v4/app/ao;)Landroid/support/v4/app/w;
    .locals 8
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/w;-><init>(Landroid/support/v4/app/ao;)V
    ...
    .line 98
    new-instance v4, Landroid/support/v4/app/w$a;

    invoke-direct {v4}, Landroid/support/v4/app/w$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/app/w$a;->a:I
    ...
    .line 104
    iget-object v5, p1, Landroid/support/v4/app/ao;->l:Ljava/util/ArrayList;
    ...
    .line 105
    iput-object v0, v4, Landroid/support/v4/app/w$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v4, Landroid/support/v4/app/w$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/app/w$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/app/w$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/app/w$a;->f:I

    .line 113
    iget v0, v4, Landroid/support/v4/app/w$a;->c:I

    iput v0, v3, Landroid/support/v4/app/w;->m:I

    .line 114
    iget v0, v4, Landroid/support/v4/app/w$a;->d:I

    iput v0, v3, Landroid/support/v4/app/w;->n:I

    .line 115
    iget v0, v4, Landroid/support/v4/app/w$a;->e:I

    iput v0, v3, Landroid/support/v4/app/w;->o:I

    .line 116
    iget v0, v4, Landroid/support/v4/app/w$a;->f:I

    iput v0, v3, Landroid/support/v4/app/w;->p:I

    .line 117
    invoke-virtual {v3, v4}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/w$a;)V
    ...
    iput v0, v3, Landroid/support/v4/app/w;->q:I

    .line 121
    iget v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput v0, v3, Landroid/support/v4/app/w;->r:I

    .line 122
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/w;->u:Ljava/lang/String;

    .line 123
    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/w;->w:I

    .line 124
    iput-boolean v7, v3, Landroid/support/v4/app/w;->s:Z

    .line 125
    iget v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v0, v3, Landroid/support/v4/app/w;->x:I

    .line 126
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/w;->y:Ljava/lang/CharSequence;

    .line 127
    iget v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v0, v3, Landroid/support/v4/app/w;->z:I

    .line 128
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/w;->A:Ljava/lang/CharSequence;

    .line 129
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/w;->B:Ljava/util/ArrayList;

    .line 130
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/w;->C:Ljava/util/ArrayList;

    .line 131
    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/w;->D:Z

    .line 132
    invoke-virtual {v3, v7}, Landroid/support/v4/app/w;->e(I)V
