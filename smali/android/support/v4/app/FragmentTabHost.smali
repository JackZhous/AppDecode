...
.method private a(Ljava/lang/String;Landroid/support/v4/app/ay;)Landroid/support/v4/app/ay;
    .locals 4
    .param p1    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/aa;
        .end annotation
    .end param
    .param p2    # Landroid/support/v4/app/ay;
        .annotation build Landroid/support/annotation/aa;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/aa;
    ...
    .line 337
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/an;

    invoke-virtual {v1}, Landroid/support/v4/app/an;->a()Landroid/support/v4/app/ay;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/ay;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/ay;
    ...
    invoke-virtual {p2, v1, v2, v3}, Landroid/support/v4/app/ay;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/ay;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/ay;->e(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/ay;
...
# virtual methods
.method public a(Landroid/content/Context;Landroid/support/v4/app/an;)V
    .locals 0
    ...
    .line 196
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/an;
...
.method public a(Landroid/content/Context;Landroid/support/v4/app/an;I)V
    .locals 2
...
.method public a(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    .line 242
    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/an;

    invoke-virtual {v2, v0}, Landroid/support/v4/app/an;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    .line 244
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/an;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/ay;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/ay;
...
.method protected onAttachedToWindow()V
    ...
    .line 265
    iget-object v5, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/an;

    iget-object v6, v0, Landroid/support/v4/app/FragmentTabHost$b;->a:Ljava/lang/String;

    invoke-virtual {v5, v6}, Landroid/support/v4/app/an;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/ay;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/ay;
    ...
    .line 286
    invoke-direct {p0, v3, v1}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/ay;)Landroid/support/v4/app/ay;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/ay;)Landroid/support/v4/app/ay;
