...
.field final synthetic h:Landroid/support/v4/h/h;


# direct methods
.method constructor <init>(Landroid/support/v4/h/h;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 0

    .prologue
    .line 340
    iput-object p1, p0, Landroid/support/v4/h/j;->h:Landroid/support/v4/h/h;

    iput-object p2, p0, Landroid/support/v4/h/j;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, Landroid/support/v4/h/j;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, Landroid/support/v4/h/j;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, Landroid/support/v4/h/j;->d:Landroid/print/PrintAttributes;

    iput p6, p0, Landroid/support/v4/h/j;->e:I

    iput-object p7, p0, Landroid/support/v4/h/j;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, Landroid/support/v4/h/j;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 344
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/h/j;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, p0, Landroid/support/v4/h/j;->h:Landroid/support/v4/h/h;

    iget-object v1, v1, Landroid/support/v4/h/h;->a:Landroid/content/Context;

    iget-object v3, p0, Landroid/support/v4/h/j;->b:Landroid/print/PrintAttributes;
    ...
    iget-object v3, p0, Landroid/support/v4/h/j;->c:Landroid/graphics/Bitmap;

    iget-object v4, p0, Landroid/support/v4/h/j;->b:Landroid/print/PrintAttributes;
    ...
    .line 351
    invoke-static {v1, v3, v4}, Landroid/support/v4/h/h;->a(Landroid/support/v4/h/h;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, v1, Landroid/support/v4/h/h;->j:Z
    ...
    .line 376
    :goto_1
    iget-object v5, p0, Landroid/support/v4/h/j;->h:Landroid/support/v4/h/h;
    ...
    iget v8, p0, Landroid/support/v4/h/j;->e:I

    .line 376
    invoke-static {v5, v6, v7, v1, v8}, Landroid/support/v4/h/h;->a(Landroid/support/v4/h/h;IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;

    move-result-object v5

    .line 380
    iget-object v6, p0, Landroid/support/v4/h/j;->h:Landroid/support/v4/h/h;

    iget-boolean v6, v6, Landroid/support/v4/h/h;->j:Z
    ...
    .line 407
    iget-object v1, p0, Landroid/support/v4/h/j;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :goto_3
    :try_start_4
    iget-object v1, p0, Landroid/support/v4/h/j;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v6, p0, Landroid/support/v4/h/j;->d:Landroid/print/PrintAttributes;
    ...
    iget-object v4, p0, Landroid/support/v4/h/j;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected a(Ljava/lang/Throwable;)V
    ...
    .prologue
    .line 426
    iget-object v0, p0, Landroid/support/v4/h/j;->a:Landroid/os/CancellationSignal;
    ...
    .line 428
    iget-object v0, p0, Landroid/support/v4/h/j;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/h/j;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/h/j;->a(Ljava/lang/Throwable;)V
