...
.method protected varargs a([Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, v0, Landroid/support/v4/h/k;->g:Landroid/support/v4/h/h;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/h/h;->a(Landroid/support/v4/h/h;Landroid/net/Uri;I)Landroid/graphics/Bitmap;
    :try_end_0
...
.method protected a(Landroid/graphics/Bitmap;)V
    ...
    iget-boolean v0, v0, Landroid/support/v4/h/h;->i:Z
    ...
    iget v0, v0, Landroid/support/v4/h/h;->m:I
    ...
    invoke-static {v0}, Landroid/support/v4/h/k;->b(Landroid/support/v4/h/k;)Landroid/print/PrintAttributes;
    ...
    invoke-static {p1}, Landroid/support/v4/h/h;->a(Landroid/graphics/Bitmap;)Z
    ...
    iput-object p1, v0, Landroid/support/v4/h/k;->b:Landroid/graphics/Bitmap;
    ...
    .line 543
    :goto_0
    iget-object v1, p0, Landroid/support/v4/h/l;->d:Landroid/print/PrintDocumentAdapter$LayoutResultCallback;
    ...
    iput-object v7, v0, Landroid/support/v4/h/k;->a:Landroid/os/AsyncTask;
...
.method protected b(Landroid/graphics/Bitmap;)V
    ...
    iput-object v1, v0, Landroid/support/v4/h/k;->a:Landroid/os/AsyncTask;
