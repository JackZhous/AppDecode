...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$i;Landroid/support/v4/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/Bundle;I)V
    ...
    .prologue
    .line 569
    iput-object p1, p0, Landroid/support/v4/media/w;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$i;

    iput-object p2, p0, Landroid/support/v4/media/w;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$j;

    iput-object p3, p0, Landroid/support/v4/media/w;->b:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/w;->c:Landroid/os/Bundle;

    iput p5, p0, Landroid/support/v4/media/w;->d:I
...
.method public run()V
    ...
    .prologue
    .line 572
    iget-object v0, p0, Landroid/support/v4/media/w;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$j;
    ...
    .line 575
    iget-object v1, p0, Landroid/support/v4/media/w;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
    ...
    iget-object v2, p0, Landroid/support/v4/media/w;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
    ...
    .line 579
    iget-object v2, p0, Landroid/support/v4/media/w;->c:Landroid/os/Bundle;

    iput-object v2, v1, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->b:Landroid/os/Bundle;

    .line 580
    iget-object v2, p0, Landroid/support/v4/media/w;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$j;
    ...
    iget v4, p0, Landroid/support/v4/media/w;->d:I

    iget-object v5, p0, Landroid/support/v4/media/w;->c:Landroid/os/Bundle;
    ...
    iget-object v4, p0, Landroid/support/v4/media/w;->e:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
