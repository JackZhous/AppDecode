...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$i;Landroid/support/v4/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    .prologue
    .line 649
    iput-object p1, p0, Landroid/support/v4/media/z;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$i;

    iput-object p2, p0, Landroid/support/v4/media/z;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$j;

    iput-object p3, p0, Landroid/support/v4/media/z;->b:Ljava/lang/String;

    iput-object p4, p0, Landroid/support/v4/media/z;->c:Landroid/os/IBinder;
...
.method public run()V
    ...
    .prologue
    .line 652
    iget-object v0, p0, Landroid/support/v4/media/z;->a:Landroid/support/v4/media/MediaBrowserServiceCompat$j;
    ...
    .line 654
    iget-object v1, p0, Landroid/support/v4/media/z;->d:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
    ...
    iget-object v2, p0, Landroid/support/v4/media/z;->b:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/media/z;->c:Landroid/os/IBinder;
