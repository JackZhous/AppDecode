...
# instance fields
.field private final A:Landroid/support/v4/widget/bo;

.field private final B:Landroid/support/v4/widget/bo;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bo;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bo$a;)Landroid/support/v4/widget/bo;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/bo;->a(I)V

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/bo;->a(F)V

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$h;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$h;->a(Landroid/support/v4/widget/bo;)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/bo;->a(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/widget/DrawerLayout$h;->a(Landroid/support/v4/widget/bo;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/bn;->a(Landroid/view/ViewGroup;Z)V
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bo;->b()I

    move-result v2

    .line 804
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;

    invoke-virtual {v3}, Landroid/support/v4/widget/bo;->b()I
...
.method public a(ILjava/lang/CharSequence;)V
    ...
    .line 769
    invoke-static {p1, v0}, Landroid/support/v4/view/m;->a(II)I
...
.method public a(Landroid/view/View;Z)V
    ...
    .line 1617
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v1

    invoke-virtual {v0, p1, v2, v1}, Landroid/support/v4/widget/bo;->a(Landroid/view/View;II)Z

    goto :goto_0

    .line 1619
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;
    ...
    .line 1619
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/bo;->a(Landroid/view/View;II)Z
...
.method a(Z)V
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;
    ...
    .line 1569
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/bo;->a(Landroid/view/View;II)Z
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;
    ...
    .line 1572
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/bo;->a(Landroid/view/View;II)Z
...
.method public b(II)V
    ...
    .line 618
    invoke-static {p2, v0}, Landroid/support/v4/view/m;->a(II)I
    ...
    .line 639
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/bo;->g()V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bo;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/bo;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bo;->c()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/bo;->c()I
...
.method e(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/m;->a(II)I
...
.method g(Landroid/view/View;)Z
    ...
    .line 1423
    invoke-static {p1}, Landroid/support/v4/view/ax;->k(Landroid/view/View;)I

    move-result v2

    .line 1422
    invoke-static {v0, v2}, Landroid/support/v4/view/m;->a(II)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/bo;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/bo;

    .line 1441
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/bo;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/bo;->e(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bo;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Landroid/support/v4/view/m;->a(II)I

    move-result v6

    .line 1068
    invoke-static {v10}, Landroid/support/v4/view/ax;->P(Landroid/view/View;)Z
    ...
    .line 1084
    invoke-static {v10}, Landroid/support/v4/view/ax;->K(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Landroid/support/v4/view/ax;->m(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/bo;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/bo;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bo;->e(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/bo;->f()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/ax;->m(Landroid/view/View;F)V
