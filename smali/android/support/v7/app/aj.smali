...
.method private static a(Landroid/content/Context;Landroid/support/v4/app/ce$a;)Landroid/widget/RemoteViews;
    .locals 4
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    .line 119
    invoke-static {v14}, Landroid/support/v7/app/aj;->a(I)I
    ...
    invoke-static/range {v2 .. v13}, Landroid/support/v7/app/aj;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;
    ...
    check-cast v2, Landroid/support/v4/app/ce$a;

    move-object/from16 v0, p0

    invoke-static {v0, v2}, Landroid/support/v7/app/aj;->a(Landroid/content/Context;Landroid/support/v4/app/ce$a;)Landroid/widget/RemoteViews;
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    .line 83
    invoke-static {p0, v2}, Landroid/support/v7/app/aj;->a(Landroid/content/Context;Landroid/support/v4/app/ce$a;)Landroid/widget/RemoteViews;
...
.method public static a(Landroid/app/Notification;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)V
    ...
    .prologue
    .line 105
    invoke-static/range {p1 .. p13}, Landroid/support/v7/app/aj;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
...
.method public static a(Landroid/support/v4/app/bw;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .prologue
    .line 51
    invoke-static/range {p1 .. p14}, Landroid/support/v7/app/aj;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
