...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/app/ak$b;,
        Landroid/support/v7/app/ak$c;,
        Landroid/support/v7/app/ak$a;,
        Landroid/support/v7/app/ak$d;
    }
.end annotation
...
.field private o:Landroid/support/v7/view/menu/e;
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/ak;->n:Ljava/util/ArrayList;

    .line 58
    new-instance v0, Landroid/support/v7/app/al;

    invoke-direct {v0, p0}, Landroid/support/v7/app/al;-><init>(Landroid/support/v7/app/ak;)V

    iput-object v0, p0, Landroid/support/v7/app/ak;->p:Ljava/lang/Runnable;

    .line 65
    new-instance v0, Landroid/support/v7/app/am;

    invoke-direct {v0, p0}, Landroid/support/v7/app/am;-><init>(Landroid/support/v7/app/ak;)V

    iput-object v0, p0, Landroid/support/v7/app/ak;->q:Landroid/support/v7/widget/Toolbar$b;
    ...
    iput-object v0, p0, Landroid/support/v7/app/ak;->i:Landroid/support/v7/widget/ad;

    .line 75
    new-instance v0, Landroid/support/v7/app/ak$d;

    invoke-direct {v0, p0, p3}, Landroid/support/v7/app/ak$d;-><init>(Landroid/support/v7/app/ak;Landroid/view/Window$Callback;)V

    iput-object v0, p0, Landroid/support/v7/app/ak;->k:Landroid/view/Window$Callback;

    .line 76
    iget-object v0, p0, Landroid/support/v7/app/ak;->i:Landroid/support/v7/widget/ad;

    iget-object v1, p0, Landroid/support/v7/app/ak;->k:Landroid/view/Window$Callback;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/ad;->a(Landroid/view/Window$Callback;)V

    .line 77
    iget-object v0, p0, Landroid/support/v7/app/ak;->q:Landroid/support/v7/widget/Toolbar$b;
...
.method private B()Landroid/view/Menu;
    ...
    .line 590
    iget-boolean v0, p0, Landroid/support/v7/app/ak;->l:Z
    ...
    new-instance v1, Landroid/support/v7/app/ak$a;

    invoke-direct {v1, p0, v3}, Landroid/support/v7/app/ak$a;-><init>(Landroid/support/v7/app/ak;Landroid/support/v7/app/al;)V

    new-instance v2, Landroid/support/v7/app/ak$b;

    invoke-direct {v2, p0, v3}, Landroid/support/v7/app/ak$b;-><init>(Landroid/support/v7/app/ak;Landroid/support/v7/app/al;)V

    invoke-interface {v0, v1, v2}, Landroid/support/v7/widget/ad;->a(Landroid/support/v7/view/menu/m$a;Landroid/support/v7/view/menu/f$a;)V

    .line 593
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/app/ak;->l:Z
...
.method static synthetic a(Landroid/support/v7/app/ak;Landroid/view/Menu;)Landroid/view/View;
    .locals 1

    .prologue
    .line 47
    invoke-direct {p0, p1}, Landroid/support/v7/app/ak;->a(Landroid/view/Menu;)Landroid/view/View;
...
.method private a(Landroid/view/Menu;)Landroid/view/View;
    ...
    .line 515
    invoke-direct {p0, p1}, Landroid/support/v7/app/ak;->b(Landroid/view/Menu;)V

    .line 517
    if-eqz p1, :cond_0

    iget-object v1, p0, Landroid/support/v7/app/ak;->o:Landroid/support/v7/view/menu/e;
    ...
    .line 522
    iget-object v0, p0, Landroid/support/v7/app/ak;->o:Landroid/support/v7/view/menu/e;

    iget-object v1, p0, Landroid/support/v7/app/ak;->i:Landroid/support/v7/widget/ad;

    invoke-interface {v1}, Landroid/support/v7/widget/ad;->a()Landroid/view/ViewGroup;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/e;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/n;
...
.method static synthetic a(Landroid/support/v7/app/ak;)Landroid/view/Window$Callback;
    .locals 1

    .prologue
    .line 47
    iget-object v0, p0, Landroid/support/v7/app/ak;->k:Landroid/view/Window$Callback;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/app/ak;Z)Z
    .locals 0

    .prologue
    .line 47
    iput-boolean p1, p0, Landroid/support/v7/app/ak;->j:Z
...
.method private b(Landroid/view/Menu;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/ak;->o:Landroid/support/v7/view/menu/e;

    .line 555
    iget-object v0, p0, Landroid/support/v7/app/ak;->o:Landroid/support/v7/view/menu/e;

    new-instance v1, Landroid/support/v7/app/ak$c;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/support/v7/app/ak$c;-><init>(Landroid/support/v7/app/ak;Landroid/support/v7/app/al;)V

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/e;->a(Landroid/support/v7/view/menu/m$a;)V

    .line 556
    iget-object v0, p0, Landroid/support/v7/app/ak;->o:Landroid/support/v7/view/menu/e;

    invoke-virtual {p1, v0}, Landroid/support/v7/view/menu/f;->a(Landroid/support/v7/view/menu/m;)V
...
.method static synthetic b(Landroid/support/v7/app/ak;)Z
    .locals 1

    .prologue
    .line 47
    iget-boolean v0, p0, Landroid/support/v7/app/ak;->j:Z

    return v0
.end method

.method static synthetic c(Landroid/support/v7/app/ak;)Landroid/support/v7/widget/ad;
    .locals 1
...
.method A()V
    ...
    .line 447
    invoke-direct {p0}, Landroid/support/v7/app/ak;->B()Landroid/view/Menu;
    ...
    .line 460
    invoke-virtual {v2}, Landroid/support/v7/view/menu/f;->i()V
...
.method public a(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/ak;->a(Landroid/view/View;)V
...
.method public a(Landroid/support/v7/app/ActionBar$c;)V
    ...
    .prologue
    .line 495
    iget-object v0, p0, Landroid/support/v7/app/ak;->n:Ljava/util/ArrayList;
...
.method public a(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/app/ak;->a(Landroid/view/View;Landroid/support/v7/app/ActionBar$LayoutParams;)V
...
.method public a(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/app/ak;->a(II)V
...
.method public a(Landroid/view/KeyEvent;)Z
    ...
    .line 468
    invoke-virtual {p0}, Landroid/support/v7/app/ak;->u()Z
...
.method public g(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/app/ak;->a(II)V
...
.method public j(Z)V
    ...
    .prologue
    .line 503
    iget-boolean v0, p0, Landroid/support/v7/app/ak;->m:Z
    ...
    .line 506
    :cond_1
    iput-boolean p1, p0, Landroid/support/v7/app/ak;->m:Z
...
.method public v()Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/ak;->p:Ljava/lang/Runnable;
