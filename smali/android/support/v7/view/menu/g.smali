...
.field private c:Landroid/support/v7/app/n;

.field private d:Landroid/support/v7/view/menu/m$a;
...
.method public a()V
    ...
    .prologue
    .line 137
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/n;
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/app/n$a;-><init>(Landroid/content/Context;)V

    .line 57
    new-instance v2, Landroid/support/v7/view/menu/e;

    invoke-virtual {v1}, Landroid/support/v7/app/n$a;->a()Landroid/content/Context;
    ...
    invoke-virtual {v2, p0}, Landroid/support/v7/view/menu/e;->a(Landroid/support/v7/view/menu/m$a;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/view/menu/f;->a(Landroid/support/v7/view/menu/m;)V
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/app/n$a;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/n$a;

    .line 65
    invoke-virtual {v0}, Landroid/support/v7/view/menu/f;->p()Landroid/view/View;
    ...
    .line 68
    invoke-virtual {v1, v2}, Landroid/support/v7/app/n$a;->a(Landroid/view/View;)Landroid/support/v7/app/n$a;

    .line 75
    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/app/n$a;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/app/n$a;

    .line 78
    invoke-virtual {v1}, Landroid/support/v7/app/n$a;->b()Landroid/support/v7/app/n;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/n;

    .line 79
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/n;

    invoke-virtual {v0, p0}, Landroid/support/v7/app/n;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 81
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/n;

    invoke-virtual {v0}, Landroid/support/v7/app/n;->getWindow()Landroid/view/Window;
    ...
    .line 71
    :cond_1
    invoke-virtual {v0}, Landroid/support/v7/view/menu/f;->o()Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v7/app/n$a;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/n$a;

    move-result-object v2

    invoke-virtual {v0}, Landroid/support/v7/view/menu/f;->n()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {v2, v0}, Landroid/support/v7/app/n$a;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/n$a;
...
.method public a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .line 152
    :cond_1
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->d:Landroid/support/v7/view/menu/m$a;
...
.method public a(Landroid/support/v7/view/menu/m$a;)V
    ...
    .prologue
    .line 128
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->d:Landroid/support/v7/view/menu/m$a;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 95
    iget-object v1, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/n;

    invoke-virtual {v1}, Landroid/support/v7/app/n;->getWindow()Landroid/view/Window;
