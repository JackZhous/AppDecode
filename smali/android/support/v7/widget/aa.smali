...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/r;I)Landroid/support/v7/widget/bi;
    .locals 3
...
.method a()V
    ...
    .prologue
    .line 130
    iget-object v0, p0, Landroid/support/v7/widget/aa;->d:Landroid/support/v7/widget/bi;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->e:Landroid/support/v7/widget/bi;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->f:Landroid/support/v7/widget/bi;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aa;->g:Landroid/support/v7/widget/bi;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->d:Landroid/support/v7/widget/bi;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->e:Landroid/support/v7/widget/bi;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/aa;->f:Landroid/support/v7/widget/bi;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aa;->g:Landroid/support/v7/widget/bi;
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bi;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/r;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bi;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 60
    sget-object v3, Landroid/support/v7/widget/aa;->b:[I
    ...
    invoke-static {v4, v0, v6}, Landroid/support/v7/widget/aa;->a(Landroid/content/Context;Landroid/support/v7/widget/r;I)Landroid/support/v7/widget/bi;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/aa;->d:Landroid/support/v7/widget/bi;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/aa;->e:Landroid/support/v7/widget/bi;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/aa;->f:Landroid/support/v7/widget/bi;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/aa;->g:Landroid/support/v7/widget/bi;
    ...
    .line 98
    :goto_1
    sget-object v5, Landroid/support/v7/widget/aa;->c:[I
