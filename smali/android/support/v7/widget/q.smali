...
# direct methods
.method constructor <init>(Landroid/widget/CompoundButton;Landroid/support/v7/widget/r;)V
    .locals 2
    ...
    .line 36
    iput-object v1, p0, Landroid/support/v7/widget/q;->c:Landroid/content/res/ColorStateList;

    .line 37
    iput-object v1, p0, Landroid/support/v7/widget/q;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 52
    iput-object p2, p0, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/r;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 90
    iget-object v0, p0, Landroid/support/v7/widget/q;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 83
    iput-object p1, p0, Landroid/support/v7/widget/q;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 94
    iput-object p1, p0, Landroid/support/v7/widget/q;->d:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/q;->a:Landroid/widget/CompoundButton;

    invoke-virtual {v4}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v3, v4, v0}, Landroid/support/v7/widget/r;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    .prologue
    .line 101
    iget-object v0, p0, Landroid/support/v7/widget/q;->d:Landroid/graphics/PorterDuff$Mode;
...
.method d()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/q;->f:Z
